...
public class DaoSQLite {
    ...
    private void visualizarVentas() throws SQLException {
        ...
        while(resultados.next()){
            System.out.println("\tID: " + resultados.getInt(1) + "\n"+
                    "\tFecha de venta: " + resultados.getString(2) + "\n" +
    ...
    private void rellenarVentas() throws SQLException {
        String sqlv1 = "INSERT INTO VENTAS VALUES (1, '2024-02-11', 2, 2, 3)";
        String sqlv2 = "INSERT INTO VENTAS VALUES (2, '2024-02-09', 1, 1, 2)";
    ...
    private void rellenarClientes() throws SQLException {
        String sqlc1 = "INSERT INTO CLIENTES VALUES (1, 'Lierni', 'Arrasate - Mondragon', 'Mondragon', '3242524','sdfa')";
        String sqlc2 = "INSERT INTO CLIENTES VALUES (2, 'Monica', 'Eibar', 'Eibar', '3242524','sdfa')";
    ...
    private void rellenarProductos() throws SQLException {
        String sqlp1 = "INSERT INTO PRODUCTOS VALUES (1, 'Lego - Hogwarts', 3, 2, 5)";
        String sqlp2 = "INSERT INTO PRODUCTOS VALUES (2, 'Lego - Regreso al Futuro Delorian', 5, 5, 3)";
